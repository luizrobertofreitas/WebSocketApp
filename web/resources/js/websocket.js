...
window.onload = init;
var socket = new WebSocket("ws://localhost:37198/socket/actions");
...
function printDeviceElement(device) {
    ...
    console.log("printDeviceElement end");
}
